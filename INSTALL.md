 ...
 **Étape 2 — Extraction du fichier téléchargé**
Sélectionner le dossier de destination et cliquer sur "Extract" pour décompresser les fichiers nécessaires à l'installation.
 ...
 **Étape 3 — Ouverture de WinSCP**
WinSCP est installé. Au premier lancement, la fenêtre de connexion s'affiche automatiquement. Le protocole SFTP et le port 22 sont déjà configurés par défaut.
...
**Étape 4 — Configuration de la connexion vers SRVWIN01**
Renseigner les informations de connexion au serveur Windows :
 ...
 **Étape 5 — Validation de la clé SSH et saisie du mot de passe**
Une alerte s'affiche pour confirmer l'ajout de la clé SSH du serveur — cliquer sur "Yes". Ensuite saisir le mot de passe du compte Administrator pour établir la connexion.
