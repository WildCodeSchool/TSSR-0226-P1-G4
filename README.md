...
|  Minjha  |            POProduct Owner | Création du Backlog et participation à la documentation du projet.Backlog   |                          Rédaction de INSTALL.md. Documentation de la réalisation                 |   SMScrum Master          |
| Cédric |                SMScrum Master |                 Gestion et encadrement du projet. Installation de KeePass sur les clients (Windows 11/Ubuntu) et la rédaction de la documentation.                             |    Tech expert         |  Mise en place de la Démonstration, Rédaction du README.md |
